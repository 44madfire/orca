...
export const CORE_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    notes: [
      ...
      'Lineage only groups worktrees in the sidebar. A child travels with its parent through review, sleep, and status moves, and is deleted with it; a top-level worktree is always its own row and survives the parent, but nothing groups it with the work it came from.',
    ...
    examples: [
      ...
      'orca worktree create --repo id:<repoId> --name agent-task --parent-worktree active --agent codex --prompt "hi" --json',
