...
// Older clients cannot round-trip Auto permission presets safely.
export const AGENT_PERMISSION_AUTO_RUNTIME_CAPABILITY = 'settings.agent-permission-auto.v1' as const
...
export const NATIVE_REMOTE_RUNTIME_CLIENT_CAPABILITIES = [
  ...
  AGENT_PERMISSION_AUTO_RUNTIME_CAPABILITY,
