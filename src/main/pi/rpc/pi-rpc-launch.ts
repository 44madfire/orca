// Vendored from 44madfire/orca-pi `packages/pi-rpc/src/launch.ts` (MIT) for
// SNC1.9 native Pi. Orca-side adaptations: none (pure spec shaping; Orca
// builds the input spec from the acquire workspaceRoot, never a profile compiler).
/**
...
export type ResolvedPiSpecLike = {
