// Vendored from 44madfire/orca-pi `packages/pi-rpc/src/errors.ts` (MIT) for
// SNC1.9 native Pi. Orca-side adaptations: none.
/**
...
const SECRET_RES: readonly { name: string; re: RegExp }[] = [
