...
const ADAPTER_FILES = new Set<string>([
  ...
  'src/session/default-host-session-file-operations.ts',
  'src/session/default-host-session-markdown-operations.ts',
  'src/session/default-host-session-native-chat-operations.ts',
  'src/session/default-host-session-operations.ts',
  'src/session/default-host-session-quick-command-operations.ts',
  'src/session/default-host-session-tab-operations.ts',
  'src/session/default-host-session-terminal-file-operations.ts',
  'src/session/default-host-session-terminal-operations.ts',
  ...
  'src/tasks/default-host-task-detail-operations.ts',
  'src/tasks/default-host-task-item-file-operations.ts',
  'src/tasks/default-host-task-item-mutation-operations.ts',
  'src/tasks/default-host-task-item-review-operations.ts',
  'src/tasks/default-host-task-linear-operations.ts',
  'src/tasks/default-host-task-list-operations.ts',
  'src/tasks/default-host-task-operations.ts',
  'src/tasks/default-host-task-preference-operations.ts',
  'src/tasks/default-host-task-project-file-operations.ts',
  'src/tasks/default-host-task-project-mutation-operations.ts',
  'src/tasks/default-host-task-project-read-operations.ts',
  'src/tasks/default-host-task-provider-write-operations.ts',
  'src/tasks/default-host-task-read-operations.ts',
...
const INLINE_RPC_BY_FILE: Record<string, number> = {
  ...
  'src/session/github-pr-mutations.ts': 3,
  ...
  'src/session/mobile-native-chat-open-file.ts': 2,
